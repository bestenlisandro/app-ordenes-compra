...
const publicUser=(u,delegatedRoles=[])=>({id:u.id,username:u.username,nombre:u.nombre,email:u.email,role:u.role,costCenter:u.costCenter,approvalLimit:u.approvalLimit==null?null:Number(u.approvalLimit),supplierId:u.supplierId,active:u.active,canChooseSupplier:u.canChooseSupplier!==false,canUseCatalogItem:u.canUseCatalogItem!==false,canUseFreeItem:u.canUseFreeItem!==false,delegatedRoles,permissions:[...new Set([...(ROLE_PERMISSIONS[u.role]||[]),...delegatedRoles.flatMap(r=>ROLE_PERMISSIONS[r]||[])])]});
