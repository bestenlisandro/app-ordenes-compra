...
import { BarChart3, Boxes, Building2, ClipboardList, Home, List, LogOut, Menu, PackageSearch, Plus, ShieldCheck, X } from 'lucide-react';
import './styles.css';
...
function Workspace({ user, onLogout }) {
  ...
  const [view, setView] = useState(allowed[0]?.[0] || 'access'); const [refreshKey, setRefreshKey] = useState(0); const [menuOpen, setMenuOpen] = useState(false);
  ...
  const content = {
    home: <HomeView user={user} onNavigate={navigate}/>,
